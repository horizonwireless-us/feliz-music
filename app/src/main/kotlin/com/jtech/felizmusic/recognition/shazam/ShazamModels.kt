package com.jtech.felizmusic.recognition.shazam
...
/**
 * Internal model of a successful Shazam recognition.
 *
 * IMPORTANT: in Zemer this is NEVER shown to the user directly. Only [title] and [artist] are used,
 * and only as a search query into the whitelist-filtered YouTube Music search — see
 * [com.jtech.felizmusic.viewmodels.RecognizeMusicViewModel]. The displayed/playable result is always a
 * whitelist-filtered `SongItem`, so a recognized but non-whitelisted song never surfaces.
 */
