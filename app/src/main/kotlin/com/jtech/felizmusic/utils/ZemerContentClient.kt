 ...
 * content.horizonwireless.us) — a periodically-refreshed plain-JSON copy of the world-readable Firestore content
...
object ZemerContentClient {
     ...
     * [com.jtech.felizmusic.statuses.parseStatusSourcesConfig] (org.json, shared with the unit tests). Kept as
